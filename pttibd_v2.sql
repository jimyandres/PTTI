...
INSERT INTO `preguntastest` VALUES (1,'Prueba','Prueba A,Prueba B,Prueba C,Prueba D'),(6,'Prueba 2','Prueba A2,Prueba B2,Prueba C2,Prueba D2'),(7,'Enunciado Prueba 3','Prueba A3,Prueba B3,Prueba C3,Prueba D3');
...
CREATE TABLE `respuestas` (
  ...
  KEY `fk_respuestas_preguntasTest1_idx` (`preguntasTest_codigoPregunta`),
  KEY `fk_respuestas_users1_idx` (`users_id`,`users_tipoUsuario_codigoTipoUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `solicitudes` VALUES ('1088098098','Aquiles','Bailo','aquilesbailo@consabor.com','CC','2016-10-11',1,'$2y$10$LJUi5Y0hUvvWVLqkyDUOtutbsPivVi3oAUmM7T8WEXmzrYC5HlUVO',NULL,'Masculino','4321432',123,1234,1,'0000-00-00 00:00:00','0000-00-00 00:00:00'),('12345678999','luis','romero','luis@utp.edu','CC','1990-10-30',1,'$2y$10$slPLxrLvgeJMAz5DmWIZ5uC2IKMHUK6fyBkQd94JX6itrBKrmjiUa',NULL,'Masculino','3333333',NULL,2,2,'0000-00-00 00:00:00','0000-00-00 00:00:00');
...
INSERT INTO `test` VALUES (1,NULL,NULL,'Prueba1',0,NULL),(6,NULL,NULL,'Prueba2',0,NULL),(7,NULL,NULL,'Prueba3',0,NULL);
...
CREATE TABLE `test_has_preguntastest` (
  ...
  KEY `fk_test_has_preguntasTest_preguntasTest1_idx` (`preguntasTest_codigoPregunta`),
  KEY `fk_test_has_preguntasTest_test1_idx` (`test_codigoTest`,`test_tipoTest_codigoTipoTest`),
  CONSTRAINT `fk_test_has_preguntasTest_preguntasTest1` FOREIGN KEY (`preguntasTest_codigoPregunta`) REFERENCES `preguntastest` (`codigoPregunta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_test_has_preguntasTest_test1` FOREIGN KEY (`test_codigoTest`, `test_tipoTest_codigoTipoTest`) REFERENCES `test` (`codigoTest`, `tipoTest_codigoTipoTest`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `test_has_preguntastest` VALUES (1,0,1),(6,0,6),(7,0,7);
...
CREATE TABLE `users_has_test` (
  ...
  KEY `fk_users_has_test_test1_idx` (`test_codigoTest`,`test_tipoTest_codigoTipoTest`),
  KEY `fk_users_has_test_users1_idx` (`users_id`,`users_tipoUsuario_codigoTipoUsuario`),
...
-- Dump completed on 2016-11-01 22:24:08
